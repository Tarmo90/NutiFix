...
function Services() {
 ...
 return (
 <section id="services" className="py-16 relative" style={{ colorScheme: "light", forcedColorAdjust: "none" }}>
 ...
 <h3 className="text-xl font-bold mb-2 text-center leading-tight" style={{ textShadow: "0 1px 3px rgba(0,0,0,0.3)" }}>{service.title}</h3>
 <p className="text-white text-center text-base leading-snug">{service.description}</p>
 ...
 className="px-5 py-2.5 bg-black/40 hover:bg-black/60 backdrop-blur-md rounded-lg text-white font-bold text-base transition-all duration-300 border-2 border-white/40 hover:border-white/80 hover:scale-105 cursor-pointer"
 >
 Vaata hinda →
 </button>
 <span className="text-base text-white font-semibold">👆 Kliki kaarti detailideks</span>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-xl font-bold mb-4 text-center leading-tight">{service.title}</h3>
 <ul className="text-left space-y-2 text-white text-base leading-snug">
 ...
 <a 
 href="#contact"
 className="px-6 py-2.5 bg-blue-600 rounded-lg hover:bg-blue-500 transition-colors text-white font-bold no-underline inline-block text-lg"
 onClick={(e) => {
 e.stopPropagation()
 }}
 >
